...
export default function PopularStreaming() {
    const settings = { //slider settings
      ...
      useEffect(() => { //pulling api with axios
        axios.get(`
        https://api.themoviedb.org/3/discover/movie?api_key=f000342215d4041012d38b11e9731a31&watch_region=US&with_watch_monetization_types=flatrate`)
